...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} SuSu
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.susu.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="name">SuSu Name</label>
                ...
                @endif
                <span class="help-block">SuSu Status</span>
            </div>
            <div class="form-group">
